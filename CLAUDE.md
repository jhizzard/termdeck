...
**Current version:** v0.3.2 (published to npm as `@jhizzard/termdeck`). All v0.1 milestones shipped on 2026-03-19. Sprints 4, 5, and 6 added onboarding, UI polish, preflight, and transcript features on top.
...
Manual testing has been the baseline through v0.3.2. For v0.4+, consider adding:
