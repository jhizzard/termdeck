...
#   - docs/RESTART-PROMPT-*.md          (frozen historical restart-prompt records;
#                                        same category as SESSION-STATUS-* and
#                                        sprint-* — written once, never revised)
...
excluded_paths_regex='(^\./node_modules/|/node_modules/|^\./dist/|^\./\.git/|^\./docs/launch/|^\./docs/sprint-|^\./docs/name-dispute|^\./docs/DOCS-HYGIENE-ROADMAP-TO-10\.md$|^\./docs/rumen-deploy-log\.md$|^\./docs/SESSION-STATUS-|^\./docs/RESTART-PROMPT-|^\./docs/tier2-verification\.md$|^\./docs/STATUS\.md$|^\./docs/CONTRADICTIONS\.md$|^\./docs/screenshots/|^\./docs-site/src/content/docs/engram/|^\./docs-site/src/content/docs/rumen/|^\./docs-site/src/content/docs/termdeck/docs/|^\./SESSION-HISTORY\.md$|^\./PLAN-rename-and-architecture\.md$)'
