...
description: "The v0.6.0 → v0.6.9 release arc rebuilt the init wizards around persist-first ordering, idempotent re-runs, access-token guidance, schema parity with Rumen, loader-precedence safety, and a front-loaded precondition audit. Here's what to know if you're upgrading or installing fresh."
draft: true
---
