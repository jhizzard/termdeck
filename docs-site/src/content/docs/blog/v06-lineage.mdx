...
description: "The v0.6.0 → v0.6.4 release arc rebuilt the init wizards around persist-first ordering, idempotent re-runs, and access-token guidance. Here's what to know if you're upgrading or installing fresh."
draft: true
---

The v0.6 series shipped fast — five point releases between 2026-04-25 and 2026-04-26 — and most of the changes are in the setup wizards. If you ran `termdeck init --mnestra` or `termdeck init --rumen` on v0.5.x or v0.6.0 and bounced off, the rest of this post explains what was broken, what's fixed, and what your upgrade path looks like.

## TL;DR

```bash
npm cache clean --force
npm i -g @jhizzard/termdeck@latest      # should resolve 0.6.4
termdeck --version                       # confirm: 0.6.4
```
...
- `@jhizzard/termdeck@0.6.4`
- `@jhizzard/termdeck-stack@0.2.3`
- `@jhizzard/mnestra@0.2.1` (unchanged through this series)
- `@jhizzard/rumen@0.4.3` (unchanged through this series)
