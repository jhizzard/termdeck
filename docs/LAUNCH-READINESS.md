...
|---|---|---|---|
| `@jhizzard/termdeck` | **0.3.5** | https://www.npmjs.com/package/@jhizzard/termdeck | https://github.com/jhizzard/termdeck |
...
- [ ] `npm view @jhizzard/termdeck version` == `0.3.5` (likewise mnestra @ 0.2.0, rumen @ 0.4.1)
...
- **Ollama embeddings** not supported in v0.3.5 (single fixed embedding model per index; migration path exists).
