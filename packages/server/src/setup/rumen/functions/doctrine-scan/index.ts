...
// either): independent cadence, budget isolation, failure isolation.
//
...
//
// Triggered on a schedule by pg_cron — see the doctrine-scan cron matcher
// this bundling change hands off to T3 (packages/cli/src/init-rumen.js's
// SCHEDULE_MIGRATIONS table currently only matches 002/003).
...
// (FUNCTIONS_WITH_VERSION_PLACEHOLDER needs a 'doctrine-scan' entry added —
// HANDOFF-REQUEST to T3, not done in this file).
import { runDoctrineScan, createPoolFromUrl } from 'npm:@jhizzard/rumen@__RUMEN_VERSION__';
